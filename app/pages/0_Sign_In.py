    ...
    <div style="background:{t['card']};border:1px solid {t['border']};
      ...
      <div class="social-row">
        ...
        <a class="soc-btn soc-google" title="Continue with Google"
           onclick="alert('Google Sign-In: Please configure Google OAuth in your Supabase dashboard to enable this feature.'); return false;" href="#">
        ...
        <!-- Facebook — active -->
        <a class="soc-btn soc-facebook" title="Continue with Facebook" href="#" onclick="alert('Facebook Sign-In coming soon!'); return false;">
        ...
        <a class="soc-btn soc-github" title="Continue with GitHub"
           onclick="alert('GitHub Sign-In: Please configure GitHub OAuth in your Supabase dashboard to enable this feature.'); return false;" href="#">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="white">
        ...
        <!-- LinkedIn — active -->
        <a class="soc-btn soc-linkedin" title="Continue with LinkedIn" href="#" onclick="alert('LinkedIn Sign-In coming soon!'); return false;">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="white">
      ...
      <div class="soc-disabled-label">Facebook & LinkedIn — Coming Soon</div>
    </div>
    """, unsafe_allow_html=True)
