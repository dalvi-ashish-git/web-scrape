...
with left_col:
    ...
    <div style="text-align:center;margin-top:1.25rem;">
      ...
      <div class="social-row">
        ...
        <!-- Facebook — active -->
        <a class="soc-btn soc-facebook" title="Facebook" onclick="alert('Facebook Sign-In coming soon!'); return false;" href="#">
        ...
        <!-- LinkedIn — active -->
        <a class="soc-btn soc-linkedin" title="LinkedIn" onclick="alert('LinkedIn Sign-In coming soon!'); return false;" href="#">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
